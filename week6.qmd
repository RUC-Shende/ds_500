...
Create a dictionary of symbol-frequency counts in a text where the keys are
ordered by increasing frequency counts.

Huffman encoding uses such an ordered dictionary to construct a **tree**
that can be used to produce an **optimal**, prefix-free code!